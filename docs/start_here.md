...
```
cmp:jump:sm section section address
cmp:jump:gr section section address
cmp:jump:eq section section address
cmp:jump:ns section section address
cmp:jump:ng section section address
cmp:jump:ne section section address
```
...
```
cmp:x:sm section section address passed_values...
cmp:x:gr section section address passed_values...
cmp:x:eq section section address passed_values...
cmp:x:ns section section address passed_values...
cmp:x:ng section section address passed_values...
cmp:x:ne section section address passed_values...
```
